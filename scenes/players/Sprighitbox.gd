...
# sets up hitbox stats. Done here instead of in main player script so each player can have different hitboxes
	match player.state:
		...
		A_H1:
			player.setHitBox(18, KB_WEAK, Vector3(1, 15, 0), "hit3")
		A_H2:
			player.setHitBox(18, KB_STRONG, Vector3(7, 50, 0), "hit3")
		A_H3:
		...
		A_AH1:
			player.setHitBox(20, KB_WEAK, Vector3(1, 15, 0), "hit3")
		A_AH2:
			player.setHitBox(25, KB_ANGLED, Vector3(25, 20, 0), "hit4")
		A_AH3_HIT:
		...
		A_SH:
			player.setHitBox(15, KB_STRONG_RECOIL, Vector3(30, 25, 0), "hit3")
