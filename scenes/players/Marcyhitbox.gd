...
# sets up hitbox stats. Done here instead of in main player script so each player can have different hitboxes
	match player.state:
		...
		A_H2:
			player.setHitBox(3, KB_STRONG, Vector3(4, 26, 0), "hit3")
		A_H3:
		...
		A_AH1:
			player.setHitBox(15, KB_ANGLED, Vector3(20, 20, 0), "hit3")
		A_AH2:
			player.setHitBox(7, KB_WEAK, Vector3(1, 0, 0), "hit2")
		A_AH3_HIT:
			player.setHitBox(20, KB_ANGLED, Vector3(20, 20, 0), "hit3")
		A_AH3_LAND:
		...
		COUNTER:
			player.setHitBox(20, KB_STRONG, Vector3(5, 40, 0), "hit3")
